        ...
        private static IList<Person> InMemoryCollection { get; } = new List<Person>
            {
                ...
                new Person { Id = 6, FirstName = "Leon", LastName = "Noel", Authorised = false, Enabled = false, Colours = new List<Colour> { new Colour { Id = 1, Name = "Red" }, new Colour { Id = 2, Name = "Green" } } },
